...
public class FileController {
    ...
    public void testDownloadFile(String filepath, HttpServletResponse respon) throws IOException {
        ...
        try {
            ...
            respon.setHeader("Content-Disposition", "attachment; filename=" + filepath);
            //写入响应
            respon.getOutputStream().write(bytes);
